-- Update parent_alerts_effective view to use alert_threshold from settings table
CREATE OR REPLACE VIEW public.parent_alerts_effective AS
SELECT a.id,
    a.created_at,
    a.content,
    a.risk_score,
