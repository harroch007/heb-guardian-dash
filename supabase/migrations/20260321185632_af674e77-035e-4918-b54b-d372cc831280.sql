...
-- Step 1: Create shabbat_times_computed cache table
...
-- Step 2: Update get_device_settings to include epoch values with fallback
...
BEGIN
    ...
    IF v_child_id IS NOT NULL THEN
        ...
        IF v_computed_shabbat IS NOT NULL THEN
          -- Use computed location-based epoch values
        ...
        ELSIF v_shabbat_row IS NOT NULL THEN
          -- Fallback: compute epoch from static Jerusalem zmanim
