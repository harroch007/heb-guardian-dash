...
export function FreeAccessCTA() {
  ...
  const button = (
    <Button size="lg" onClick={handleCTA} className="bg-primary text-primary-foreground hover:bg-primary/90 text-lg h-14 px-10 rounded-xl font-bold glow-primary w-full sm:w-auto">
    ...
    <section className="py-16 md:py-24" dir="rtl">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          className="max-w-4xl mx-auto bg-card border border-primary/30 rounded-3xl p-10 md:p-14 text-center shadow-2xl shadow-primary/20 relative overflow-hidden"
        >
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Button size="lg" variant="outline" disabled className="text-lg h-14 px-10 rounded-xl">
                קרוב
              </Button>
            </div>
          </div>
