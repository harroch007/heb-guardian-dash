...
const APP_ICONS: Record<string, { icon: React.ElementType; color: string; bgColor: string }> = {
  ...
  'com.zhiliaoapp.musically': { icon: Music, color: '#000000', bgColor: 'rgba(255, 0, 80, 0.15)' },
  'com.ss.android.ugc.trill': { icon: Music, color: '#000000', bgColor: 'rgba(255, 0, 80, 0.15)' },
