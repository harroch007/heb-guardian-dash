...
בחבילת Premium - מחיר משתנה לפי מספר הילדים: ילד אחד ב-29₪, שניים ב-45₪, שלושה ב-60₪.
...
חבילת Premium ב-29₪ לחודש נותנת שקט נפשי אמיתי - כל מה שבחינם + הגנה מלאה 24/7 עם ניתוח AI + שירות לקוחות VIP.
שני ילדים ב-45₪, שלושה ב-60₪.
