...
const steps = [
  {
    ...
    description: "מתקינים את האפליקציה בטלפון של הילד. 95% מהניתוח מתבצע ישירות על המכשיר - התוכן לא עוזב את הטלפון. אנחנו מקבלים רק התראות כשמזוהה סכנה אמיתית. ניתן לנתק בכל רגע.",
    bullets: [
      "95% מהעיבוד על המכשיר",
      "פרטיות מקסימלית",
      "התרעות רק כשצריך"
    ]
  },
