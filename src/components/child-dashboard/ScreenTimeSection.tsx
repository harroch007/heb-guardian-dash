            ...
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0 text-right">
                ...
                <p className="mt-1 text-xs font-normal text-muted-foreground">
                  {effectiveLimit ? `${Math.round(currentUsageMinutes)} מתוך ${effectiveLimit} דקות היום` : `${Math.round(currentUsageMinutes)} דקות היום`}
                </p>
              </div>
            </div>
            ...
            {filteredApps.length > 0 && (
              <>
                ...
                <p className="text-[11px] text-muted-foreground/70 mt-2 px-1">
                  * זמן המסך הכולל כולל גם אפליקציות מערכת ורקע. כאן מוצגות רק האפליקציות בהן הילד/ה השתמש/ה באופן פעיל.
                </p>
              </>
            )}
