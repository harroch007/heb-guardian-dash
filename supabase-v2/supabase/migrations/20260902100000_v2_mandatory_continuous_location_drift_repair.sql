-- Forward-only repair for a ledger/schema drift discovered on 2026-09-02.
-- The historical migration remains immutable; this file reasserts its contract.
begin;
...
begin
    ...
    loop
        perform public.v2_enqueue_refresh_for_child_service(
            ...
            null::uuid,
            'mandatory-location-drift-repair-v1:' || affected_row.child_id::text,
...
-- Recreate by name so a same-name but weakened or unvalidated drift cannot pass.
alter table public.v2_parental_settings
